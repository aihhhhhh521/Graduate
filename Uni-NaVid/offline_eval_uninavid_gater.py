...
class UniNaVid_Agent():
    ...
    def reset(self, task_type='vln'):
        ...
        # enable token gater (hard top-k in eval)
        self.model.config.mm_use_gater = True
        self.model.config.gater_k = self.gater_k
...
if __name__ == '__main__':
    ...
    agent = UniNaVid_Agent("model_zoo/uninavid-7b-full-224-video-fps-1-grid-2", gater_k=args.gater_k)
    agent.reset()
