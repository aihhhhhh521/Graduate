...
class UniNaVIDMetaForCausalLM(ABC):
    ...
    def _update_visual_token_stats(self, lengths_list, nav_token_count=0):
        ...
        # Sum up all valid history-token lengths.
        history_tokens = 0
            ...
            if image_counts is not None:
                if is_navigation: # Navigation
                    ...
                    if hasattr(self, "_update_visual_token_stats"):
                        ...
                        self._update_visual_token_stats(lengths_list, nav_token_count=nav_token_count)
                    ...
                    if hasattr(self, "_update_visual_token_stats"):
                        self._update_visual_token_stats(lengths_list, nav_token_count=0)
